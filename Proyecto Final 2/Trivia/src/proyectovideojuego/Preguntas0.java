...
/*SE TIENEN 4 JFrame DISTINTOS CON PREGUNTAS VARIADAS PARA 4 CASILLAS DE PREGUNTAS
    Las respuests correctas se muestran en el panel de salida*/
public class Preguntas0 extends javax.swing.JFrame 
{
    private final Jugador jugador;
    //Las preguntas se guardan en un arreglo al igual que las respuestas se aguardan en otro arreglo de tal forma que se puedan ver todas las opciones
     String[] preguntas = {"¿Qué representa la palabra \"calpulli\" en la cultura náhuatl?"
                        ,"¿Qué significa \"nahualli\" en náhuatl?"
                        ,"¿Cuál es la traducción de la palabra \"xicalli\" en náhuatl?"};
    //el último elemento es la respuesta correctacon la que comprobaremos la respuesta que seleccionada el usuario con el último elemento
    String[][] respuestas = {{"Templo","Ciudad","Clase noble","Comunidad"}
                        ,{"Maíz","Hechicero o brujo","Sol","Lluvia"}
                        ,{"Serpiente de cascabel","Recipiente de agua","Guerrero valiente","Árbol sagrado"}};
    int index = 0;//contador para la posicion de las respuestas que estan en el arreglo 
    int puntos = 0;
    ButtonGroup bg = new ButtonGroup();
     
    public Preguntas0(Jugador jugador) 
    {
    ...
    //la seleccion de respuesta (solo deja escoger una y no puedes cambiarla)
    public void getSelectedOPtion(JRadioButton rbtn)
    {
        //obtener el valor seleccionado de la radioButton que tomo el valor de rbtn
        System.out.println(rbtn.getText());
        System.out.println(respuestas[index][2]);
        //Comprueba si el usuario seleccionó la respuesta correcta.
    ...
    {
        //control para habilitar o inabilitar los accesos directos al teclado
    ...
    private void initComponents() {
        ...
        txtRespuesta1.setForeground(new java.awt.Color(255, 0, 0));
        ...
        txtRespuesta2.setForeground(new java.awt.Color(255, 0, 0));
        ...
        txtRespuesta3.setForeground(new java.awt.Color(255, 0, 0));
        txtRespuesta3.setText("respuesta 3 (correcta)");
        ...
        txtPregunta.setBackground(new java.awt.Color(204, 255, 204));
        ...
        txtRespuesta4.setForeground(new java.awt.Color(255, 0, 0));
        ...
        btnBotonOpciones.setBackground(new java.awt.Color(153, 255, 153));
        btnBotonOpciones.setFont(new java.awt.Font("Chalkduster", 0, 14)); // NOI18N
        btnBotonOpciones.setForeground(new java.awt.Color(204, 0, 0));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtRespuesta3, javax.swing.GroupLayout.DEFAULT_SIZE, 425, Short.MAX_VALUE)
                            .addComponent(txtRespuesta4, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                .addContainerGap())
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(139, 139, 139)
                .addComponent(btnBotonOpciones, javax.swing.GroupLayout.PREFERRED_SIZE, 153, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(btnBotonOpciones, javax.swing.GroupLayout.DEFAULT_SIZE, 36, Short.MAX_VALUE)
                .addGap(15, 15, 15))
        );
    ...
    private void btnBotonOpcionesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBotonOpcionesActionPerformed
        if(btnBotonOpciones.getText().equals("Regresar"))
        {
            ...
            jugador.puntos(puntos);//guarda los puntos en el array en la posicion del jugador actual
            //cierra 
            this.setVisible(false);
        }
      
        if(index == preguntas.length)//compara el numero de pregunta con el tamaño del arreglo de las preguntas
        {
            // muestra los puntos
            txtPregunta.setText("Puntos optenidos: " + puntos + " / " + preguntas.length);
            btnBotonOpciones.setText("Regresar");//cambia el titulo del baton para indicar que terminaron las preguntas y puede regresar al tablero 
        }
        
        else{
             enableRbuttons(true);
             // siguiente pregunta incremento del lugar de la respuesta segun la pregunta y asignacion a que se muestre en pantalla a traves de los RadioBoton
             ...
             if(index == preguntas.length-1){// si se termino de mostrar todas la preguntas y se termino de igual manera de contestarlas se cambia el texto del boton para indicar que el jugador puede pedir los resultados
    ...
    public static void main(String args[]) 
    {
        java.awt.EventQueue.invokeLater(() -> {
            Jugador jugador = new Jugador();
                new Preguntas0(jugador).setVisible(true);
        });
    }
