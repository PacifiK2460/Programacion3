...
public class Seleccion extends javax.swing.JFrame {
    ...
    public Seleccion(ArrayList<Usuarios> usuariosList) 
    {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Selecciona el usuario con el que quieres jugar");
    ...
    public void actualizaCombo(){
        for (int i = 0; i < usuariosList.size(); i++) {
            combo.addItem( String.valueOf(usuariosList.get(i).getId()));
        }
    }
